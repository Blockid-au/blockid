...
| `accelerator_intake` | Intake link | A$249 / 2,490 (annual-first) | 24900 / 249000 · ids ✓ | 249 + 2490 inclusive | `STRIPE_PRICE_ACCEL_INTAKE(_ANNUAL)` | 14 | `/pricing?segment=programs#tier-intake`, `/solutions/accelerator` | ✓ |
...
## 13. Free allowance — two free business reports per e-mail (G25-C, 2026-09-21)
