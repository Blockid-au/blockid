...
**Latest live checkpoint23/09,11:14UTC:** BlockID compiled `1c30818be0ec2b7714bb5625b04e9aa673aabfa4` active4121/warm4120; SVI compiled `c70aaaee3e2a402154170c7c371b752f1a2cb26d` active4208/warm4207. BlockID now reads the actual PPTX text-array contract, preserves PDF parser page numbers/blank positions, rejects PDF byte noise and cleans intake temp files. Candidate packaging includes the13 missing sharp0.35.4 ESM files before freeze, matching source tracing fix `048ceb92b`; retained warm4120 predates this fix and is not a fully qualified visual rollback. SVI shows and retains bounded visual coverage metadata in new reports/overview/print views; old reports unchanged. Claude's Office archive/URL redirect fixes were integrated. Production builds and public identity/HTTP/static admission succeeded; no operator-started inference probe or additional test suite. **G30 and semantic qualification remain open.** [Live receipt](../reviews/2026-09-23-document-provenance-rollout.md). Prior vision/budget scope remains active under the US$0.50 DeepInfra-only limit.
