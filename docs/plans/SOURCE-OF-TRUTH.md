...
**Latest live checkpoint23/09,12:53UTC:** BlockID compiled `5339080e49b062e1bc719bb4bcdf6f5dc27af17f` active4125/warm4124; SVI remains compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. BlockID evaluator full-run completion now requires its saved snapshot document. Interactive/batch/intake callers insert the canonical document together with the evaluation quota/billing record and confirm returned JSON before publishing readiness; unconfirmed interactive persistence returns503 without a share URL. Build/public SHA/HTTP/static admission succeeded. Origin4121 explicitly retired with artifacts preserved and scoped unknown-work acknowledgement. No migration, historical rewrite, additional suite or operator provider call. Snapshot updates remain mutable/separate writes; immutable public revisions and financial/job reconciliation remain open. **Full G30 implementation and qualification remain open.** [Current live receipt and revision-reader dependencies](../reviews/2026-09-23-evaluator-persistence-rollout.md); [prior assembled/SVI persistence receipt](../reviews/2026-09-23-final-report-persistence-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
