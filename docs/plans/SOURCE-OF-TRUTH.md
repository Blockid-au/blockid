...
- **S11 in flight:** **S11-A** Founder Radar activation nudge (sweep finds 4 subscribers / 0 targets — none has a profile): in-app + email once, one follow-up at 14 d, cap 2, migration 0327.
