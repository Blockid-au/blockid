...
**Current verified checkpoint — 22/09/2026 19:08 UTC:** BlockID **v3.33.3 / `cba40ad1ea49e7447ba4575a5211689462f83391`**, active4111 / warm4110; SVI **`9c42491a9628384fa8cff3d91667e369516ff9da`**, active4203 / warm4202. Both actual rollback→forward drills passed. SVI now exposes private accepted detail for all16 questions and preserves the selected question through sign-in. Reading does not charge credits. New customer research production, receipt creation, financial schema expansion and automatic evidence-to-SVI/valuation publication remain **not activated**. Source commits after these compiled SHAs are preparation, not live features. This checkpoint supersedes older “latest” statements below only for the named slices. [BlockID release evidence](../reviews/2026-09-22-receipt-compatibility-live.md).
