...
**Latest live checkpoint24/09,01:04UTC:** BlockID compiled `a0b6f6f7d008002cfbc362928a93a3cec082c477` active4130/warm4129; SVI remains compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. Legacy stream/dimension persistence now also writes and confirms the immutable `report_revisions` artifact; stream save status becomes `save_failed` when immutable persistence is uncertain. The writer retains SHA-256 unknown-commit recovery, while daily snapshot tokens remain compatibility projections. Migration 0410 remains applied but empty pending a real controlled report run; source migration restoration awaits schema-authority compatibility/rollback approval. Origin4124 was retired with exact identity and artifact retention to respect the six-origin cap; detached-work coverage remains unknown. HTTP/static/identity gates and mark-good succeeded. **Full G30 implementation and qualification remain open.** [Current stream receipt](../reviews/2026-09-24-stream-revision-rollout.md); [recovery receipt](../reviews/2026-09-24-revision-recovery-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
