...
- **Live QA sweep S25–S29 in flight** (2026-09-13 12:55 UTC): lane 1 hydrated founder journeys on production (`qa-founder-20260913@`), lane 2 API contract/CSRF/IDOR/rate-limit/credit-preview/erasure (`qa-api-20260913@`); reports `reviews/live-qa-s25-s29-lane{1,2}-2026-09-13.md`; QA accounts erased at the end.
