...
- **S12 in flight:** **S12-A** site-wide title/description sweep test + fixes (`/pricing` still double-suffixed etc.) and visible FAQs + `FAQPage` on `/funding/grants|programs`.
