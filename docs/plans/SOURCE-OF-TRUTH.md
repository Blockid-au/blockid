...
**Latest live checkpoint23/09,14:36UTC:** BlockID compiled `0edf8bc62d326470b8543b041c9b2eb08b788178` active4127/warm4126; SVI remains compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. BlockID share readers now consult the applied `report_revisions` table first, validate non-revoked ReportV2 JSON, then fall back to `svi_snapshots`; this reader-only bridge is live with HTTP 200, static/identity gates and mark-good complete. The applied 0410 table is empty; its source migration is deferred from the candidate because schema authority requires an expanded compatibility/rollback transition. No revision writer, token rewrite, historical backfill, or full immutable preservation is claimed. Candidate 4127 was promoted after exact cleanup of the prior unregistered candidate; artifacts remain retained. O08 quiescence and detached-work coverage remain incomplete. **Full G30 implementation and qualification remain open.** [Current immutable-reader receipt](../reviews/2026-09-23-immutable-reader-rollout.md); [prior reader-bridge receipt](../reviews/2026-09-23-reader-bridge-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
