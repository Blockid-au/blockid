...
- **Live QA sweep S25–S29** (2026-09-13 12:55–14:00 UTC; reports [`reviews/live-qa-s25-s29-lane1-2026-09-13.md`](./reviews/live-qa-s25-s29-lane1-2026-09-13.md) 53 rows · 35 pass / 9 pass-with-note / 6 fail / 3 blocked, [`lane2`](./reviews/live-qa-s25-s29-lane2-2026-09-13.md) 275 checks · 266 pass; all QA accounts erased). Found and **fixed — LIVE 12/12, 14:04 UTC**:
  ...
  - **S30-A in flight:** today's manual lane-1/lane-2 journeys are being codified into a reusable Playwright project `live-qa` (`web/tests/live-qa/`, `npm run qa:live`, self-provisioned `qa-live-<stamp>@blockid.au` account erased in teardown, weekly Sunday 07:00 UTC proposal, `content/reports/live-qa-latest.json`); its first production run doubles as the re-verification of today's fixes.
