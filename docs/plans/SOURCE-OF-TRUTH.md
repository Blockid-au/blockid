...
- **S31-C** (in flight): capacity audit for a trial surge (process model, nginx/Cloudflare caching, DB pool + `audit_events` chain-trigger cost, rate-limit keying for shared IPs, modest read-only load test, cron contention), report `reviews/capacity-audit-2026-09-13.md`.
