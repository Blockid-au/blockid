...
- **S18 in flight:** **S18-A** convert the remaining ~75 `getProjectIdFromRequest` routes to `getProjectScope` (viewer/editor/admin), fix `data-room` account keys, static scope guard.
