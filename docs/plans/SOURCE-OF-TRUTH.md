...
**Budget được founder chốt23/09:** **US$0.50/report tối đa**, dùng chung text + vision, **chỉ DeepInfra**, không provider trả phí khác. Ledger durable theo report scope, reserve trước dispatch, giữ reservation khi usage không rõ. Đây là ngân sách report; không tự diễn giải là quyền chạy benchmark trả phí không giới hạn. Price policy hiện tại hết hạn23/10/2026 và phải cập nhật từ giá official trước khi tiếp tục dispatch. Source phase vision `6cb2d2db7`/SVI `1a1fd3f` đang rollout; không suy source là live hoặc full quality certification.

**Latest live checkpoint23/09,09:35UTC:** BlockID compiled `ae954a4b33f2769229b7f51856527d195530e97f` active4118/warm4117 đã đưa lên model-scoped timeout/transport fixes, truthful valuation labels/low-n producer gate và OCR cục bộ có giới hạn, bỏ false vision fallback. SVI compiled `ac8f26d23e224bbb4475b6205f5b755cd9a66ab8` active4206/warm4205 đã đưa lên raster-as-text rejection và source visual contract. Public identity xác nhận riêng từng site; các test bổ sung/rollback drill hoãn theo chỉ đạo mới nhất. **Chưa bật multimodal report analysis, chưa chứng nhận model/semantic quality, G30 chưa hoàn tất.** [Live receipt và giới hạn](../reviews/2026-09-23-report-visual-foundation-live.md). Mốc này thay trạng thái source-only bên dưới chỉ cho các phần đã nêu.
