...
- **S17 in flight:** **S17-A** project-level permissions made real (member-aware listing/access, `assertProjectAccess` on project-scoped routes, role-aware UI) · **S17-B** AUD valuation band on the SVI trend chart + connected-MRR revenue-multiple cross-check.
