...
**Latest live checkpoint24/09,00:30UTC:** BlockID compiled `619631e0f94023ca8f77a71e333e96ba28a0ea1a` active4129/warm4128; SVI remains compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. The immutable reader/writer is live and now recovers unknown commits by hashing the canonical ReportV2 document and reusing an existing non-revoked revision for the same snapshot/hash before insert. New rows still require exact read-back; existing daily snapshot tokens remain compatibility projections. Migration 0410 remains applied but empty pending a real controlled report run; source migration restoration still awaits schema-authority compatibility/rollback approval. No historical rewrite/backfill is claimed. HTTP/static/identity gates and mark-good succeeded; O08 artifacts remain retained and detached-work/quiescence coverage is incomplete. **Full G30 implementation and qualification remain open.** [Current recovery receipt](../reviews/2026-09-24-revision-recovery-rollout.md); [writer receipt](../reviews/2026-09-23-immutable-writer-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
