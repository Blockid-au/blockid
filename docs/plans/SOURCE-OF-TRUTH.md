...
**Latest live checkpoint23/09,12:32UTC:** BlockID compiled `6f4e841308a96311fe45e2625df8015a69bb6b75` active4124/warm4123; SVI compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. BlockID assembled generation atomically inserts the canonical document with complete status and confirms returned content before completion; order retries share one durable budget scope. SVI atomically replaces each report JSON file and persists before terminal completion. Per-file replacement is not a two-file transaction or immutable revisions. Production builds/public identity/HTTP/static admission succeeded; BlockID operational mark-good uses deferred extended review. Origin4120 explicitly retired with artifacts preserved and unknown-work acknowledgement. No historical report rewrite, operator provider call or additional suite. **Full G30 implementation and qualification remain open.** [Current live receipt and next priorities](../reviews/2026-09-23-final-report-persistence-rollout.md); [prior citation/read-policy receipt](../reviews/2026-09-23-citation-and-read-policy-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
...
| F02/T02 completion persistence | PARTIAL LIVE23/09 / ACCEPTANCE DEFERRED | BlockID assembled row + canonical JSON + complete status inserted together and returned document confirmed; done withheld until save. Order retries share the US$0.50 DeepInfra scope. SVI uses atomic per-file replacement, slug-before-completed-run publication and done-after-save in both pipelines. No immutable revisions, two-file transaction, unknown-commit reconciliation or complete legacy-writer coverage. [Live receipt and next priorities](../reviews/2026-09-23-final-report-persistence-rollout.md) |
...
| O08 origin activity and drain | EXPLICIT RETIREMENT TOOL LIVE / AUTOMATIC QUIESCENCE OPEN | Registry, drain/resume and separate locked retirement helper live. Scoped retirements preserve artifacts and active/warm origins; latest4120 freed one cap slot. Zero tracked work is not proof against detached/external jobs: explicit unknown-work acknowledgement remains required. Durable jobs/checkpoints and full coverage remain open. [Foundation](../reviews/2026-09-22-g30-origin-drain-foundation.md), [latest retirement](../reviews/2026-09-23-final-report-persistence-rollout.md) |
