...
**Latest live checkpoint23/09,11:43UTC:** BlockID compiled `dd966d47d7c42bbb360de8598ec5ff1b30c151e4` active4122/warm4121; SVI compiled `2399e6682c2a666fff9012ab66a6ee555e57e830` active4209/warm4208. New BlockID file intakes keep OCR/vision observations out of deterministic scoring, maturity, valuation fallback and submitted-financial quotations; native/user text remains self-reported, never independent verification. Empty native pages no longer trigger classifier calls. SVI HTML/plain-text report emails now include saved EN/VI visual reading limits before conclusions. Production builds and public identity/HTTP/static admission succeeded; BlockID marked operationally good with extended review deferred. All13 sharp ESM files traced natively into the new bundle; warm4121 includes the previous repair. Origin4118 explicitly retired with artifacts preserved; full quiescence remains unproven. No historical report rewrite, operator inference probe or additional test suite. **G30 and semantic qualification remain open.** [Current live receipt](../reviews/2026-09-23-scoring-source-rollout.md); [prior native document/coverage receipt](../reviews/2026-09-23-document-provenance-rollout.md). US$0.50/report DeepInfra-only policy unchanged.
...
| O08 origin activity and drain | PARTIAL LIVE / FULL RETIREMENT GATE OPEN | Branchec90dbfed (g30/retained-origin-drain) adds persistent activity registry, authenticated drain/resume, request admission closure and selected detached scopes.5 focused tests, scoped TypeScript and14 serving-state checks passed. Coverage is incomplete; retirementEligible remains false. Legacy origins have no retrospective work-ownership proof; idle sockets, elapsed time and SIGTERM alone do not prove no jobs. [Scope/legacy evidence](../reviews/2026-09-22-g30-origin-drain-foundation.md). Foundation is included in the current release; this does not establish legacy quiescence. Separately authorized4102/4103 retirements are recorded in serving state with artifacts preserved |
