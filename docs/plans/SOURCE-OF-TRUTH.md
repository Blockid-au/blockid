...
**Latest live checkpoint23/09,12:07UTC:** BlockID compiled `4ed64320123d1691a60dd6a2ef8c2fc569c68579` active4123/warm4122; SVI compiled `6ace6b0df7a3030299ad40f8f9287a64edba4271` active4210/warm4209. BlockID no longer repairs mistyped full evidence IDs, accepts IDs from an empty catalogue, or silently hides unresolved citations in shared renderers. Section audit checks cited numeric amount/currency compatibility; this is not full semantic entailment. Pipeline cache version is now`r10-citation-integrity`. SVI report reads no longer trigger OpenAI/Anthropic chart enrichment; missing scores/valuation remain unavailable, recorded risk likelihood is distinct from severity, canonical valuation drives the report header/chart, and scoped policy blocks legacy Claude synthesis. Production builds/public identity/HTTP/static admission succeeded; BlockID operational mark-good uses deferred extended review. Origin4119 explicitly retired with artifacts preserved and unknown-work acknowledgement. No historical report rewrite, operator provider call or additional suite. **Full G30 implementation and qualification remain open.** [Current live receipt](../reviews/2026-09-23-citation-and-read-policy-rollout.md); [prior numeric-source/coverage receipt](../reviews/2026-09-23-scoring-source-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
...
| O08 origin activity and drain | EXPLICIT RETIREMENT TOOL LIVE / AUTOMATIC QUIESCENCE OPEN | Registry, drain/resume and separate locked retirement helper live. Scoped retirements preserve artifacts and active/warm origins; latest4119 freed one cap slot. Zero tracked work is not proof against detached/external jobs: explicit unknown-work acknowledgement remains required. Durable jobs/checkpoints and full coverage remain open. [Foundation](../reviews/2026-09-22-g30-origin-drain-foundation.md), [latest retirement](../reviews/2026-09-23-citation-and-read-policy-rollout.md) |
