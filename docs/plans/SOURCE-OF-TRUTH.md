...
**Latest live checkpoint23/09,13:27UTC:** BlockID compiled `0cb6d0bda47bd870d0467e7964e35a9cf8fb076c` active4126/warm4125; SVI remains compiled `93478aa926f2db2283b4ebb74871594a7700ff27` active4211/warm4210. BlockID public EN/VI share pages now use the same canonical ReportV2 reader bridge as PDF, with stored-document validation and legacy adapter fallback. Build/public SHA/HTTP/static admission and mark-good succeeded; origin4123 explicitly retired with artifacts preserved and scoped unknown-work acknowledgement. No schema migration, writer change, historical rewrite, additional suite or operator provider call. Immutable public revisions and financial/job reconciliation remain open. **Full G30 implementation and qualification remain open.** [Current reader-bridge receipt](../reviews/2026-09-23-reader-bridge-rollout.md); [prior evaluator persistence receipt](../reviews/2026-09-23-evaluator-persistence-rollout.md). DeepInfra-only US$0.50/report remains unchanged.
