...
| Provider data-handling sentence (G12 T0275) | "confidential" claim in the ChatGPT comparison | **APPROVED by founder 2026-09-10** — publish the conservative form: "Your inputs are not used to train our models; founder-consented access tiers control who sees what; reports are generated by our AI providers under their business terms." T0275 still verifies each provider's policy in the free-model chain before the sentence goes live. | Founder ✅ (CISO verification at T0275) |
