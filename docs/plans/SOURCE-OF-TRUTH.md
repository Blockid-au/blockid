...
- **Sequence:** scheduled deploy of the review fixes 2026-09-11 12:05 UTC → live verify + smoke → merge S6-A/B/C → full suite → second off-peak deploy → post-ship review → fix → SOT sync. Still human-blocked elsewhere: G1 (InfoVision ABN, `STRIPE_PRICE_ADDON_SHARE_MGMT_*`), G2 #6/#7/#10 wording, G7 Q1–Q4, GA4 `hero_variant` dimension.
