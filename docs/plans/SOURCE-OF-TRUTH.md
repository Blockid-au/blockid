...
| B01 pack base prices | PARTIAL READ-ONLY VERIFIED | Five live active AUD Stripe pack base prices match web5/9/20/35/60. Disabled billing-service larger-pack catalogue is stale; final tax/checkout totals, nonpack families and entitlement fulfillment remain open. [Price parity](../reviews/2026-09-22-g30-credit-pack-price-parity.md) and [active writers/schema](../reviews/2026-09-22-g30-billing-runtime-inventory.md) |
