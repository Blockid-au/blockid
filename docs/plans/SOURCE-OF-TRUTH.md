...
**Latest live checkpoint23/09,10:29UTC:** BlockID compiled `6cb2d2db74cba2e62c1b329c75ad3c3981249594` active4120/warm4119; SVI compiled `1a1fd3f1e3d67ff84481bfbb7f30611b040c9bae` active4207/warm4206. Direct-image OCR/DeepInfra vision, bounded PDF/Office images and shared US$0.50 report budget are deployed. SVI excludes unverified image observations from financial inputs. Production builds and public identity/HTTP/static admission succeeded; no inference probe or semantic benchmark ran. Max3 visual units/document,55s; Office embedded images only, not full slide rendering. **G30 and quality qualification remain open.** [Live receipt](../reviews/2026-09-23-deepinfra-visual-budget-live.md). This replaces older source-only statements only for these slices.
