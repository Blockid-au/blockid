...
| G33 T01–T16 (test live 24/09) | **S0, S1, T13, T16–T16i, S2 (T08–T11) LIVE** — `75f7c9c4c`, origin 4140 | S0/S1 live 04:00; T16 SYNTH reserve, T16b–e model choice/min attempt/background W4 150 s/model-busy strike; S2: audit chain graph-verified (13 971 rows, SQL 0460 applied live), svi-snapshot owner fix, `report_revisions` source restored (0461), no mail to erased identities. Canary 09:10: 0/8 degraded, 4 296 từ, 292 s. **Chưa claim S1 acceptance** (năng lực DeepInfra dao động); grounded 0.47–0.82 < 0.85 (E03/Q02). Canary sau T16f: 4 run liên tiếp 0/8 degraded (09:10–09:43); sau đó 11:37–12:56 lại có 1–4 chương degraded do throughput DeepInfra 9–21 tok/s → **S1 acceptance chưa đạt**; mọi lỗi phía code đã sửa (T16g hedge, T16h model đã duyệt giá, T16i dàn tải). T13: `/api/actions` từng trả lịch sử của bất kỳ email nào không cần đăng nhập — đã chặn (401). Còn: 1 run nữa cho S1 acceptance, S3 (Lane A), T12–T15. SQL ngoài `migrations/` ở `web/supabase/pending-authority/` để giữ schemaDigest/warm rollback. [Receipt S0+S1](../reviews/2026-09-24-g33-s0-s1-live.md) · [Receipt T16+S2](../reviews/2026-09-24-g33-t16-s2-live.md) |
