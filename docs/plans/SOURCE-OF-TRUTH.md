...
**Revision:** G30 / 2.6 — APPROVED IMPLEMENTATION — 22/09/2026. **Owner quyết định:** Do Van Long.
...
**Latest live milestone11:37UTC:** v3.32.0/3073058a0, [investor report detail live evidence](../reviews/2026-09-22-g30-investor-detail-live.md). Operational checks and founder-authorized60-second soak passed; broader review deferred. Compatible warm rollbacks v3.31.0/6732b1115 at4105 andv3.30.1/c867ce271 at4104 remain. Only previously approved4102 was stopped;4103 and other retained origins remain running. Scoped paid research/SQL migrations and qualified free fallback remain unactivated. SVI compiled8b181401 is live at4202 with scoped DeepInfra routing, private configuration and an actual successful warm rollback/forward drill; [evidence](../reviews/2026-09-22-g30-svi-live.md).
...
**Next BlockID deploy capacity:** six live retained origins remain. Founder has been asked specifically about stopping only inactive4103/v3.30.0 after verified v3.32.0, retaining current and4105/4104 warm rollbacks plus all artifacts. This question is pending; previous4102 approval does not authorize4103. Source implementation and SVI operations continue independently; no retirement is inferred from elapsed time or idle HTTP sockets.
