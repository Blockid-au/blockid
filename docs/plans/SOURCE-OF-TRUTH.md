...
**Current verified checkpoint — 22/09/2026 19:19 UTC:** BlockID **v3.33.3 / `cba40ad1ea49e7447ba4575a5211689462f83391`**, active4111 / warm4110; SVI **`c58514726b60e8bcfca068d2503c2bdb86cbb462`**, active4204 / warm4203. Both actual rollback→forward drills passed. SVI now exposes private accepted detail for all16 questions and preserves the selected question through sign-in. Reading does not charge credits. New customer research production, receipt creation, financial schema expansion and automatic evidence-to-SVI/valuation publication remain **not activated**. Source commits after these compiled SHAs are preparation, not live features. This checkpoint supersedes older “latest” statements below only for the named slices. [BlockID release evidence](../reviews/2026-09-22-receipt-compatibility-live.md).
