...
Supporting bullets: consistent verdicts (vs model-to-model variance) · no hallucinated founder histories — claims are tied to evidence or marked missing · confidential: founder-consented access tiers, no pasting decks into a public chat (**CISO/CLO to confirm provider data-handling wording before publishing**) · time: minutes, not 30–60 min per deck · audit trail for your IC / LP.
...
| D4 | Doctoral-research wording | "grounded in the founder's doctoral research (DBA) on startup valuation" — founder approves exact sentence |
