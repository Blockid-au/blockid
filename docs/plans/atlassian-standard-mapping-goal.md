...
*Last updated: 2026-07-24 by autonomous loop (tick shipping P1d — AU ESOP Scheme Rules test block + goal-file annotation; template body already on disk from Round 5.6b). This file survives `git reset --hard` because it is committed + pushed on every tick.*
