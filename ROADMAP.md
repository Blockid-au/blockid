...
| **G15 R1–R3** Reliability: deploy manifest truth + lock etiquette, error digest + latency SLO + `/api/status` v2, weekly restore drill, AI health snapshot, stray-process sweep | — | P0 | **in progress 2026-09-18** | Goal doc [`docs/plans/reliability-2026-09-18.md`](./docs/plans/reliability-2026-09-18.md); SOT § G15 |
