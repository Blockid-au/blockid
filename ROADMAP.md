...
| **G22 A–D** Upgrade hardening: dossier access for batch members, invited batches listed, weights editor, org_id on batches/intakes (org-scoped retention/export), VI parity for the trust/pilot bands, in-app institutional API docs, 375/dark UX pass, /admin/validation tracker + weekly G21 regression lane | — | P1 | **open 2026-09-21** → v3.22.0 | SOT § G22; `docs/plans/g22-upgrade-hardening-2026-09-21.md` |
