...
| **G23 A–C** Report grounding to the 0.85 KPI (owner citations, budgets, verdict trim), pilot proposal PDF + pilot → annual conversion credit, ops hygiene (partial live-qa marker, log rotation, ledger lock) | — | P1 | **open 2026-09-21** → v3.23.0 | SOT § G23; `docs/plans/g23-grounding-proposals-2026-09-21.md` |
