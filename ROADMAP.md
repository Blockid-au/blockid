...
| **G34 BT0–BT6 · DC/EM/RQ** Biz Trust Report v4: investor-first dashboard (5 tiles, key metrics, 8-dimension scorecard with lead agent, red flags), 8 dimension modules (78 criteria, owner agent + 2 judges each) feeding G32 accumulative scoring, user data per profile, compliant lifecycle email (12 flows) | — | **P1** (BT1/BT2 P0) | **PLAN ONLY (25/09)** — awaiting D24; BT3/BT5/BT6 replace G33 S4–S6 content | SOT §10.14 / §12.13; [plan](docs/plans/g34-biz-trust-report-v4-quality-2026-09-25.md) |
