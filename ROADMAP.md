...
| **G17 P1–P2** Unicorn homepage + site template: evaluator-first hero, 5-item nav, `/product` + `/samples` intro pages, template primitives on every marketing page, link checker | — | P0 | **in progress 2026-09-19** | Goal doc [`docs/plans/unicorn-homepage-2026-09-19.md`](./docs/plans/unicorn-homepage-2026-09-19.md); SOT § G17 |
| **G16 A–C** First dollar: funnel events + daily funnel + real `/admin/funnel`, locked TBR preview → A$3 quote-then-pay + gate cards + nudge, evaluator pilot comp + `/pilot` | — | P0 | **in progress 2026-09-19** | Goal doc [`docs/plans/first-dollar-2026-09-19.md`](./docs/plans/first-dollar-2026-09-19.md); SOT § G16 |
