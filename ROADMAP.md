...
| **G23 A–C** Report grounding to the 0.85 KPI (auto-citer, salvage, budgets, verdict trim), pilot proposal PDF + pilot → annual conversion credit (0434), ops hygiene (partial live-qa summaries, cron logs, ledger If-Match, status grounding row) | — | P1 | **LIVE 2026-09-21 v3.23.0** (`c6e94a033`, 12/12) → QA + review | SOT § G23; `docs/plans/g23-grounding-proposals-2026-09-21.md` |
| **G24 A–C** Citations as footnotes + evidence appendix (no raw markers), AI-run integrity (prompt-version registration, 401 → unconfigured, funding_round feed), demo cohort for buyer demos (`is_demo` 0436, zero AI cost, excluded from benchmarks/index) | — | P1 | **open 2026-09-21** → v3.24.0 | SOT § G24; `docs/plans/g24-report-readability-demo-cohort-2026-09-21.md` |
