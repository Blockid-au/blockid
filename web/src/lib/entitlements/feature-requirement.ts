...
const FROM_LABELS: Readonly<Record<string, string>> = Object.freeze({
  "/workspace/cap-table": "Cap Table",
  "/workspace/data-room": "Data Room",
  "/workspace/esop": "ESOP",
  "/workspace/vesting": "Vesting",
  "/workspace/clean-room": "Clean Room",
  "/workspace/listing-readiness": "Listing Readiness",
  "/workspace/secondary-offer": "Secondary Offer",
  "/workspace/equity-offer": "Equity Offer",
  "/workspace/branding": "Custom Branding",
  "/workspace/api-keys": "API Keys",
  "/workspace/investor-pack": "Investor Pack",
  "/workspace/fundraise": "Fundraise",
  "/workspace/funding": "Money Finder",
  "/workspace/evidence": "Evidence Vault",
  "/workspace/term-sheet": "Term Sheet AI",
  "/workspace/accelerator/quarterly-report": "Quarterly Report",
  "/dashboard/exit-readiness": "Exit Readiness",
