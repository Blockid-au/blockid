...
describe("event catalogue", () => {
  it("lists the six subscribable events with labels; ping is not subscribable", () => {
    expect([...WEBHOOK_EVENTS]).toEqual(["svi.rescored", "evidence.uploaded", "funding.report_ready", "evaluation.report_ready", "intake.submission_received", "feedback_letter.sent"]);
