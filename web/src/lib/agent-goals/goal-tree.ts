...
export const CEO_GOAL_TREE: AgentGoal = {
  ...
  subGoals: [
    ...
    },
    {
      id: "cfo-goal",
      agent: "cfo",
      title: "VC-Grade Valuation & Financial Intelligence",
      mission: "Produce professional, VC-standard startup valuations: market sizing (TAM/SAM/SOM), multi-method valuation (VC Method, DCF, comparables, risk-factor summation), full financial projections, unit economics, break-even, payback, and a financial-injection plan — every number backed by a cited research basis. Own and continuously upgrade src/lib/agents/cfo-valuation.ts; keep sector multiples/benchmarks current. See .claude/goals/cfo-vc-valuation.md.",
      kpis: [
        { metric: "valuation_methods", label: "Valuation Methods per Report", target: 4, unit: "methods" },
        { metric: "mrr_growth", label: "MRR Growth Rate", target: 15, unit: "%" },
        { metric: "gross_margin", label: "Gross Margin", target: 80, unit: "%" },
        { metric: "benchmark_freshness_days", label: "Benchmark Freshness", target: 7, unit: "days" },
      ],
      criteriaOwned: ["revenue", "dataroom"],
      reportSections: ["revenue", "valuation", "au_market"],
      skills: ["/cfo", "/cfo revenue", "/cfo unit-economics", "/investor-relations"],
      researchTopics: [
        "VC valuation methods: VC Method, DCF, comparables, Berkus, Scorecard, Risk-Factor Summation — formulas + when each applies",
        "Sector ARR/revenue multiples (SaaS, fintech, AI, marketplace, healthtech) — Bessemer, SaaS Capital, PitchBook, Carta",
        "Market sizing methodology: top-down vs bottom-up TAM/SAM/SOM with credible AU/global sources",
