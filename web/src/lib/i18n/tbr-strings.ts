...
const v2En: TbrV2Strings = {
  ...
  s47: {
    ...
    worthParagraph: (low, high, pct) => `The weighted valuation estimate sits between ${low} and ${high} (confidence ${pct}%), from the applicable methods weighed in the Valuation chapter.`,
    ...
    purpose: {
      ...
      valuation: "The methods that apply at this stage, their inputs and how the weighted range was reached.",
...
const v2Vi: TbrV2Strings = {
  ...
  s47: {
    ...
    worthParagraph: (low, high, pct) => `Ước tính định giá có trọng số nằm trong khoảng ${low} đến ${high} (độ tin cậy ${pct}%), từ các phương pháp áp dụng được cân nhắc ở chương Định giá.`,
    ...
    purpose: {
      ...
      valuation: "Các phương pháp áp dụng ở giai đoạn này, đầu vào của chúng và cách tính khoảng có trọng số.",
...
const valuationEn: TbrValuationStrings = {
  confidence: (pct) => `evidence confidence ${pct}%`,
  low: "Low",
  consensus: "Weighted estimate",
  high: "High",
  ...
  askVerdict: { aligned: "aligned", above_consensus: "above weighted estimate", below_consensus: "below weighted estimate" },
...
const valuationVi: TbrValuationStrings = {
  confidence: (pct) => `độ tin cậy bằng chứng ${pct}%`,
  low: "Thấp",
  consensus: "Ước tính có trọng số",
  high: "Cao",
  ...
  method: {
    ...
    berkus: "Berkus",
    dcf_proxy: "Hệ số ARR điều chỉnh (ước lượng)",
    comparables: "Hệ số ARR theo ngành/tăng trưởng",
    risk_factor_summation: "Hệ số ARR điều chỉnh thuế (ước lượng)",
    scorecard: "Scorecard (Bill Payne)",
  ...
  askVerdict: { aligned: "phù hợp", above_consensus: "cao hơn ước tính có trọng số", below_consensus: "thấp hơn ước tính có trọng số" },
