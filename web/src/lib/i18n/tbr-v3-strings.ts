...
const en: TbrV3Strings = {
  ...
  bandLabel: { A: "Investable now", B: "With conditions", C: "Not yet", D: "Insufficient evidence" },
  bandWording: {
    A: "Evidence supports investment consideration now",
    B: "Investable with conditions",
  ...
  condAsk: (gapPct, low, high) => `Re-anchor the ask: ${gapPct} % above the ${low}–${high} consensus`,
  ...
  kpConsensus: (low, high, methods) => `Consensus ${low}–${high} across ${methods} method${methods === 1 ? "" : "s"}`,
  ...
  riskAsk: (gapPct) => `Ask sits ${gapPct} % above the consensus range`,
  mitigationUnverified: "Upload documents or connect the source",
  mitigationAsk: "Re-anchor the ask to the consensus range",
  ...
  noRisks: "No material risk rows — every dimension is evidenced above its stage median.",
  thAction: "Action",
  thLift: "Lift",
  thWindow: "Window",
  thDim: "Dimension",
  ...
  askChip: { aligned: "ask aligned", above_consensus: "ask above consensus", below_consensus: "ask below consensus" },
  askNone: "ask —",
  ...
  movesRevenue: (m) => `Connect Stripe or Xero → ${m} revenue method${m === 1 ? "" : "s"} run (+${m} method${m === 1 ? "" : "s"} in the consensus)`,
  ...
  movesClaims: (n) => `Verifying ${n} self-declared claim${n === 1 ? "" : "s"} lifts consensus confidence`,
...
const vi: TbrV3Strings = {
  ...
  bandLabel: { A: "Có thể đầu tư ngay", B: "Kèm điều kiện", C: "Chưa đến lúc", D: "Chưa đủ bằng chứng" },
  bandWording: {
    A: "Bằng chứng đủ để xem xét đầu tư ngay",
    B: "Có thể xem xét đầu tư, kèm điều kiện",
  ...
  condAsk: (gapPct, low, high) => `Điều chỉnh mức gọi vốn: cao hơn ${gapPct} % so với khoảng đồng thuận ${low}–${high}`,
  ...
  kpConsensus: (low, high, methods) => `Đồng thuận ${low}–${high} từ ${methods} phương pháp`,
  ...
  riskAsk: (gapPct) => `Mức gọi vốn cao hơn ${gapPct} % so với khoảng đồng thuận`,
  mitigationUnverified: "Tải tài liệu lên hoặc kết nối nguồn dữ liệu",
  mitigationAsk: "Điều chỉnh mức gọi vốn về khoảng đồng thuận",
  ...
  noRisks: "Không có dòng rủi ro trọng yếu — mọi chiều đều có bằng chứng trên trung vị giai đoạn.",
  thAction: "Hành động",
  thLift: "Mức tăng",
  thWindow: "Thời hạn",
  thDim: "Chiều",
  ...
  askChip: { aligned: "mức gọi vốn phù hợp", above_consensus: "mức gọi vốn cao hơn đồng thuận", below_consensus: "mức gọi vốn thấp hơn đồng thuận" },
  askNone: "mức gọi vốn —",
  ...
  movesRevenue: (m) => `Kết nối Stripe hoặc Xero → ${m} phương pháp doanh thu được chạy (+${m} phương pháp trong đồng thuận)`,
