...
export const publicResearchSchema = z.object({
  ...
  sources: z.array(z.object({ id: z.string(), url: z.string(), title: z.string(), role: z.enum(["business", "market_or_alternative"]), status, reason: z.string(), fetchedAt: z.string().nullable(), publishedAt: z.null(), contentSha256: z.string().nullable(), excerpt: z.string().max(1600), relevance: z.literal("not_assessed"), citable: z.literal(false) })).max(5),
