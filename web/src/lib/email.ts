...
// G34-BT2 EM07 — the transport (sendEmail, erased-recipient guard, send log,
// C-class gate, List-Unsubscribe) lives in ./email-core, which has no app
// imports so lib/ops-alert-email.ts can use it without pulling lib/auth.
export { sendEmail, withFromName, isErasedRecipient, ERASED_RECIPIENT_DOMAIN } from "./email-core";
export type { SendResult } from "./email-core";
