...
export const LEGAL_TEMPLATES: LegalTemplate[] = [
  ...
  {
    slug: "au-esic-self-assessment",
    title: "AU ESIC Self-Assessment Worksheet (Div 360 ITAA97)",
    category: "fundraising",
    phase_slug: "phase-9",
    summary:
      "Walkable Div 360 ITAA97 worksheet founders complete before marketing a round as ESIC-qualifying — 4 Limb-1 gateway tests + 100-point s360-45 objective test + 5-part principles-based test + ATO PBR fallback + s18 ACL / s1041H Corps Act misleading-conduct disclosure guardrails.",
    file_path: "web/content/templates/legal/au-esic-self-assessment.md",
    version: "1.0",
    revision_date: "2026-07-25",
    disclaimer: DISCLAIMER_SHORT,
    placeholders: [
      ...
      "prepared_by_name",
      "prepared_by_role",
      "tax_agent_reviewed_by",
      "tax_agent_number_tpb",
      "limb1_age_result",
      "limb1_income_result",
      "limb1_expenses_result",
      "limb1_listed_result",
      "limb1_overall_result",
      "item_australian_patent",
      "australian_patent_number",
      "item_innovation_patent",
      "innovation_patent_number",
      "item_plant_breeder_rights",
      "pbr_number",
      "item_accelerator_alumni",
      "accelerator_programme_name",
      "item_third_party_capital",
      "third_party_capital_amount_aud",
      "item_rd_15_to_50",
      "item_rd_above_50",
      "rd_percent",
      "item_licensed_from_university",
      "university_licence_counterparty",
      "item_trademarks_note",
      "limb2a_total_points",
      "limb2a_pass_result",
      "principles_genuinely_focused_narrative",
      "principles_genuinely_focused_evidence",
      "principles_genuinely_focused_result",
      "principles_high_growth_narrative",
      "principles_high_growth_evidence",
      "principles_high_growth_result",
      "principles_scalable_narrative",
      "principles_scalable_evidence",
      "principles_scalable_result",
      "principles_competitive_advantage_narrative",
      "principles_competitive_advantage_evidence",
      "principles_competitive_advantage_result",
      "principles_broader_market_narrative",
      "principles_broader_market_evidence",
      "principles_broader_market_result",
      "limb2b_overall_result",
      "ato_pbr_obtained",
      "ato_pbr_reference",
      "ato_pbr_issued_date",
      "ato_pbr_scope_note",
      ...
      "retention_end_date",
      "founder_signature",
      "founder_signature_date",
      "director_signatory_name",
      "director_signature",
      "director_signature_date",
      "tax_agent_signature",
      "tax_agent_signature_date",
      "revision_date",
    ],
    sources: [
      {
        label:
          "Income Tax Assessment Act 1997 (Cth) — Division 360 (Tax incentives for early stage investors) — s360-15, s360-40, s360-45, s360-50",
        url: "https://www.legislation.gov.au/C2004A05138/latest/text",
      },
      {
        label:
          "ATO Product Ruling TR 2019/1 — Early stage innovation company (ESIC) framework",
        url: "https://www.ato.gov.au/law/view/document?DocID=TXR/TR20191/NAT/ATO/00001",
      },
      {
        label:
      ...
      {
        label:
          "Tax Agent Services Act 2009 (Cth) — Tax Practitioners Board registration + investor-reliance sign-off",
        url: "https://www.legislation.gov.au/C2009A00013/latest/text",
      },
      {
        label:
          "Corporations Act 2001 (Cth) — s911A (AFSL licensing), s923B (financial-services boundary), s127 (execution), s286 (7-year record-keeping), s1041H + s769C (misleading conduct in financial products)",
        url: "https://www.legislation.gov.au/C2004A00818/latest/text",
      },
      {
        label:
          "Taxation Administration Act 1953 (Cth) — Schedule 1 Division 359 (Private Binding Rulings)",
        url: "https://www.legislation.gov.au/C2004A07040/latest/text",
      },
      {
        label:
          "Privacy Act 1988 (Cth) — Australian Privacy Principles (Schedule 1) — APP 11 (security of personal information)",
        url: "https://www.legislation.gov.au/C2004A03712/latest/text",
      },
      {
        label:
