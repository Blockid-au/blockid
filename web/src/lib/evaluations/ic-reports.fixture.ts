...
export function fakeView(over: { mine?: Partial<EvaluationAssessment> | null; consensus?: DossierView["consensus"]; signature?: DossierView["signature"] } = {}): DossierView {
  ...
  return {
    ...
    header: {
      ...
      svi: 62, sviBand: "developing", delta30d: 4, percentile: { value: 61, source: "real_cohort", cohortSize: 120, label: "segmented benchmark (n = 120)" }, consentTier: "reports_shared", ownerKind: "founder_claimed", founderClaimed: true,
