...
export function DeepDiveUpsell() {
  return (
    <div className="rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50 to-violet-50/40 shadow-sm p-5 flex flex-col h-full">
      ...
      <Link
        href="/"
        className="flex items-center justify-center gap-2 rounded-xl bg-action px-4 py-2.5 text-sm font-semibold text-on-action hover:bg-action-hover transition-colors"
      >
        Run Deep Dive
