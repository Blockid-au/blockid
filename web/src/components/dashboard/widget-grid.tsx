        ...
        {editMode ? (
          <div className="flex items-center gap-2 rounded-full border border-brand-200 bg-brand-50 px-2 py-1 text-xs">
            ...
            <button
              ...
              className="inline-flex min-h-6 items-center gap-1 rounded-full bg-action px-3 py-1 font-medium text-on-action hover:bg-action-hover"
        ...
        if (!editMode) {
          return (
            <div key={id} data-widget-slot={id} className="relative">
              {isPinned && (
                <span
                  className="absolute -top-2 right-4 z-10 inline-flex items-center gap-1 rounded-full bg-action px-2 py-0.5 text-[10px] font-semibold text-on-action shadow-sm"
