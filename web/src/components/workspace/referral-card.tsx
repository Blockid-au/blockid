    ...
    <div className="rounded-2xl border border-surface-200 bg-gradient-to-br from-white to-brand-50/30 p-6 shadow-sm">
      ...
      <div className="flex items-center gap-2 rounded-xl border border-surface-200 bg-white px-3 py-2">
        ...
        <button
          type="button"
          onClick={handleCopy}
          className="shrink-0 inline-flex items-center gap-1.5 rounded-lg bg-action px-3 py-1.5 text-xs font-semibold text-on-action hover:bg-action-hover transition-colors cursor-pointer"
        >
          {copied ? (
            <>
