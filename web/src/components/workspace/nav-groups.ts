...
const VALIDATE_SUBGROUPS: NavSubgroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/workspace/svi-trend", label: "SVI Trend", icon: Activity, minPlan: "starter", minTier: "starter", growthPhase: 2 },
    ],
  },
  {
    id: "validate.track",
...
const ACCOUNT_SUBGROUPS: NavSubgroup[] = [
  {
    ...
    items: [
      ...
      { href: "/workspace/feedback", label: "Feedback & Credits", icon: MessageSquare },
    ],
  },
  {
    id: "account.billing",
