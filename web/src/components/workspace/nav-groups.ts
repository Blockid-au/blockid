...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/workspace/metrics", label: "Metrics", icon: BarChart3, minPlan: "starter" },
      { href: "/workspace/reports", label: "Weekly Reports", icon: Activity, minPlan: "starter" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/workspace/cap-table", label: "Cap Table", icon: Table2, minPlan: "growth" },
      { href: "/workspace/shareholders", label: "Shareholders", icon: Shield, minPlan: "growth" },
      { href: "/workspace/esop", label: "ESOP Setup", icon: Users, minPlan: "growth" },
      { href: "/workspace/vesting", label: "Vesting", icon: Calendar },
      { href: "/workspace/wallet", label: "Wallet", icon: Wallet },
      { href: "/workspace/equity-esop", label: "ESOP Manage", icon: PieChart, minPlan: "scale" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/advisor", label: "Advisor Portal", icon: Share2, minPlan: "scale" },
