    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Link
          ...
          className="inline-flex min-h-11 items-center text-xs font-semibold px-3 rounded-lg bg-white/70 hover:bg-white ring-1 ring-current/20 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-action"
        >
          {copy.read}
        </Link>
        <button
          ...
          className="inline-flex min-h-11 min-w-11 items-center justify-center text-xs font-medium px-2 rounded-lg hover:bg-white/40 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-action"
        >
