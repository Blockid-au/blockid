...
const PHASES: Phase[] = [
  ...
  },
  {
    number: 9,
    name: "Quality Gate",
    subtitle: "Autonomous nightly C-Level review",
    description: "Six C-Level agents review every commit overnight. Regressions surface within 24 hours, not at code-freeze.",
    status: "planned",
    eta: "Q4 2026",
    icon: ShieldCheck,
    color: "text-cyan-600",
    ...
    features: [
      "Nightly CTO/CFO/CDO/CISO/CRO/CMO review",
      "Diff-scoped agent audits",
      "Auto Telegram alerts on P0/P1",
      "3-night false-positive suppression",
      "Weekly full-tree deep audit",
    ],
  },
  {
    number: 10,
    name: "Investor Pack v2",
    subtitle: "One-click PDF from workspace state",
    description: "Generate a 15-page investor pack in under 5 seconds. Share via tracked links; capture investor responses in-app.",
    status: "planned",
    eta: "Q1 2027",
    icon: FileText,
    ...
    features: [
      ...
      "Cover, SVI, cap-table, traction, teaser",
      "Share links with view tracking",
      "Investor-response capture form",
      "Founder notification on link open",
    ],
  },
  {
    number: 11,
    name: "AU Startup Index",
    subtitle: "Public SEO surface — /index + /listings/[ticker]",
    description: "Public, opt-in, SVI-scored index of Australian startups. Every listing is an inbound funnel.",
    status: "planned",
    eta: "Q1 2027",
    icon: Globe,
    color: "text-sky-600",
    ...
    features: [
      "ASX-style ticker per listing",
      "JSON-LD Organization + Dataset",
      "Comparable-set internal linking",
  ...
  {
    number: 12,
    name: "VI Founder Cohort",
    subtitle: "Vietnamese-Australian localised surface",
    description: "Vietnamese-language onboarding, workspace top-20, Zalo distribution, and accelerator partnerships for the AU-VN diaspora.",
    status: "planned",
    eta: "Q2 2027",
    icon: Languages,
    ...
    features: [
      "/vi/* Next 16 locale routing",
      "VI onboarding wizard variant",
      "Zalo Official Account broadcast",
      "6 VI SEO articles",
      "Vietnamese-AU accelerator partnerships",
    ],
  },
];
