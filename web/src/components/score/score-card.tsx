...
export function ScoreCard({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -inset-px rounded-2xl bg-gradient-to-br from-teal-500/10 via-transparent to-transparent"
      />
      <div className="relative">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-md bg-teal-500/15 text-teal-300 ring-1 ring-teal-500/30">
          ...
          <span className="inline-flex items-center gap-1 rounded-full border border-ink-700 bg-ink-800 px-2 py-0.5 text-[10px] uppercase tracking-wider text-slate-400">
            <Sparkles strokeWidth={1.75} className="h-3 w-3 text-teal-400" />
            v2
          </span>
        </div>

        <div className="mt-6 flex items-end gap-2">
          <span className="font-mono tabular-nums text-7xl font-semibold tracking-tight text-teal-400 leading-none">
            {score}
          </span>
