  ...
  return (
    <div className="space-y-2" data-testid="cohort-import">
      <div className="flex flex-wrap items-center gap-2">
        <label
          htmlFor={inputId}
          className={`inline-flex min-h-11 cursor-pointer items-center gap-2 rounded-xl border border-brand-300 bg-surface px-4 py-2.5 text-sm font-semibold text-brand-700 transition-colors hover:bg-surface-hover ${busy ? "pointer-events-none opacity-60" : ""}`}
        >
