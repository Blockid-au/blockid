...
export function TbrInvestorScreening({ report, locale = "en", lockCards, citations }: {
  ...
  return <div className="space-y-5 border-t border-line-subtle pt-6" data-tbr-investor-screening>
    ...
    <div className="grid items-start gap-3 md:grid-cols-2 xl:grid-cols-3">
      {view.signals.map((signal, i) => <details key={signal.key} className="group min-w-0 rounded-xl border border-line-subtle bg-surface" data-investor-signal={signal.key} data-state={signal.status}>
