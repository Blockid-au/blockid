...
export function TbrReportV2({ report: rawReport, strings, locale = "en", upgradeHref, afterChapters, afterExecutive, unlock, benchmarks, canCorrect = false }: TbrReportV2Props) {
  const t = { ...EN, ...strings };
