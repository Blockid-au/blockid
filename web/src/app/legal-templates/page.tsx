    ...
    <main className="mx-auto max-w-5xl px-6 py-16">
      ...
      <ul className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {templates.map((tpl) => (
          <li
            key={tpl.slug}
            className="flex flex-col rounded-xl border border-line-subtle bg-white p-6 shadow-sm transition hover:shadow-md"
          >
            <div className="mb-3 inline-flex w-fit items-center rounded-full bg-surface-sunken px-2.5 py-0.5 text-xs font-medium text-slate-700">
            ...
            <Link
              ...
              className="mt-5 inline-flex items-center justify-center rounded-md bg-action px-4 py-2 text-sm font-medium text-on-action hover:bg-action-hover"
            >
              Preview template →
            </Link>
          </li>
      ...
      <footer className="mt-16 border-t border-line-subtle pt-6 text-xs text-muted">
