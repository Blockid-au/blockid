// Wave 31D — Japanese public share page for a Trusted Business Report.
// Same auth-less fetch-by-token as /tbr/[token], but the shell UI renders
// in Japanese via locale="ja".
...
export const metadata: Metadata = {
  title: "事業レポート — BlockID Startup Value Index",
  description:
    "信頼できる事業レポート: SVI 8項目、13項目の投資家評価基準、バリュエーション・レンジ、改善ロードマップ。",
...
export default async function JaTbrSharePage({
  params,
  searchParams,
}: {
