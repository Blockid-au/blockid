...
const TITLE = "R&D Tax Incentive calculator — free tool";
const DESCRIPTION = "Calculate your estimated R&D Tax Incentive benefit for Australian startups. 43.5% refundable offset for small businesses, 38.5% for larger companies. Free.";
