// Wave 25 Phase B — Vietnamese public share page for a Trusted Business
// Report. Same auth-less fetch-by-token as /tbr/[token], but the shell UI
// renders in Vietnamese via locale="vi".
