...
//   f. TrustBand           lane P0-A's primitive, mounted after merge (see
  ...
  return (
    <div className="min-h-screen bg-surface text-primary">
      ...
      <main id="main-content">
        ...
        {/* f. TRUST BAND — G21 P0-A: <TrustBand /> mounts here after merge
            (import { TrustBand } from "@/components/marketing/template";
            operating entity · ABN/ACN · methodology version · privacy and
            evidence controls · score disclaimer · audit trail · founder
            consent · data ownership). Lane P0-B does not create that file. */}
