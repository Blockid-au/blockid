// /workspace/weekly-digest — nav-linked stub while the full page is built.
...
export const metadata: Metadata = {
  ...
  description: "Auto-generated digest of your portfolio's week.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-16 text-center">
      <h1 className="text-3xl font-semibold text-ink-900">Weekly Digest</h1>
      <p className="mt-4 text-ink-600">Auto-generated digest of your portfolio's week.</p>
