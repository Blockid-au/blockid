            ...
            {links.map((link) => (
              <div key={link.scoreId} className="rounded-xl border border-surface-200 bg-white overflow-hidden">
                <div className="px-5 py-4 border-b border-surface-100 bg-surface-50 flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4 text-right flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-muted">unique</p>
                    </div>
                  </div>
                </div>
                ...
                {link.accesses.length > 0 ? (
                    ...
                    <tbody className="divide-y divide-surface-100">
                      {link.accesses.map((a) => (
                        <tr key={a.id} className="hover:bg-surface-50">
                          ...
                          <td className="px-4 py-2.5 text-xs text-muted truncate max-w-[200px] hidden sm:table-cell">
                  ...
                  <div className="px-5 py-4 text-xs text-muted">No views yet — share this link with investors.</div>
                )}
              </div>
            ))}
          </div>
