...
export function EquityWizard({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push("/workspace/equity/cap-table");
    } catch (err) {
      setSaveError(
            ...
            <div className="flex items-start gap-3">
              ...
              {idx > 0 && (
                <button
                  ...
                  className="mt-5 h-8 w-8 flex items-center justify-center rounded-lg text-muted hover:text-rose-600 hover:bg-rose-50 transition-colors cursor-pointer shrink-0"
                  title="Remove"
                >
