// /workspace/equity hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function EquityHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="equity">{children}</HubTabsProvider>;
}
