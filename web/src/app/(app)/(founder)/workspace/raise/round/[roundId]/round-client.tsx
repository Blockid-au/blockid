  ...
  if (!data?.ok || !data.round || !data.summary) {
    return (
      <div className="space-y-4">
        <Link href="/workspace/raise/round" className="inline-flex items-center gap-1 text-sm text-brand-600 hover:underline">
  ...
  return (
    <div className="space-y-8" data-testid="fundraise-round">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <Link href="/workspace/raise/round" className="inline-flex items-center gap-1 text-xs text-brand-600 hover:underline">
      ...
      <section className="rounded-2xl border border-surface-200 bg-white p-5" aria-labelledby="round-dataroom-heading">
        ...
        {dataRoom ? (
          <p className="mt-2 text-sm text-ink-600">
            ...
            <Link href="/workspace/documents/data-room" className="text-brand-600 hover:underline">
              Open the data room
            </Link>{" "}
