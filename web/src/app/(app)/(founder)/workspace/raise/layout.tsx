// /workspace/raise hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function RaiseHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="raise">{children}</HubTabsProvider>;
}
