...
export default async function ProfilePage() {
  ...
  if (!user) redirect("/auth/login?next=/workspace/settings/profile");
        ...
        <div className="bg-white border border-surface-200 shadow-sm rounded-2xl p-6 space-y-4">
          <div className="flex items-center gap-4">
            {user.avatarUrl ? (
              ...
              <div className="h-14 w-14 rounded-full bg-action-hover flex items-center justify-center text-xl font-bold text-white">
