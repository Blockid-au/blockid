                ...
                <div className="px-5 pb-5">
                  {isCurrent ? (
                    ...
                    <button
                      ...
                      className={cn(
                        "w-full h-9 rounded-[10px] bg-action text-sm font-semibold text-on-action hover:bg-action-hover transition-colors cursor-pointer flex items-center justify-center gap-1.5",
          ...
          {CREDIT_PACKS.map((pack) => {
            ...
            >
              ...
              <button
                ...
                className={cn(
                  "w-full h-9 rounded-lg bg-action text-sm font-semibold text-on-action hover:bg-action-hover transition-colors cursor-pointer flex items-center justify-center gap-1.5",
