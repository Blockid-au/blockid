// /workspace/accelerators/criteria — full searchable list of all 30+ criteria
...
export default async function AcceleratorCriteriaPage() {
  ...
  if (!user) redirect("/auth/login?next=/workspace/accelerators/criteria");
    ...
    <WorkspaceLayout user={user} isSandbox={isSandbox}>
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="space-y-2">
          <Link href="/workspace/score" className="inline-flex items-center gap-1 text-xs text-blue-600 hover:underline">
        ...
        <div className="rounded-xl border border-purple-200 bg-purple-50/50 p-4 flex items-start gap-3">
          ...
          <div className="text-xs text-foreground">
            ...
            <p className="text-muted-foreground mt-1 leading-relaxed">
              ...
              <Link href="/workspace/score" className="text-blue-600 hover:underline">SVI analysis</Link> —
