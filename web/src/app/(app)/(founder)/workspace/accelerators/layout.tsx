// /workspace/accelerators hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function AcceleratorsHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="accelerators">{children}</HubTabsProvider>;
}
