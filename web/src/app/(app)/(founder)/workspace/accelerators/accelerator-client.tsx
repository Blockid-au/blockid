...
function EvidenceBinder({
  ...
  const items = [
    ...
    { label: "Product/MVP evidence", value: "Check /workspace/score", done: stage >= 2, icon: Rocket },
    { label: "Cap table documented", value: "Check /workspace/esop/manage", done: false, icon: Award },
    { label: "Financial projections", value: "Check /workspace/finance", done: false, icon: BookOpen },
