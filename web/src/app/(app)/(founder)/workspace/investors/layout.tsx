// /workspace/investors hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function InvestorsHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="investors">{children}</HubTabsProvider>;
}
