// /workspace/sso — nav-linked stub while the full page is built.
...
export const metadata: Metadata = {
  ...
  description: "SAML/OIDC SSO configuration. Available on Enterprise plans.",
...
export default function Page() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-16 text-center">
      <h1 className="text-3xl font-semibold text-ink-900">Single Sign-On</h1>
      <p className="mt-4 text-ink-600">SAML/OIDC SSO configuration. Available on Enterprise plans.</p>
