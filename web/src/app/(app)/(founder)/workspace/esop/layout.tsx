// /workspace/esop hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function EsopHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="esop">{children}</HubTabsProvider>;
}
