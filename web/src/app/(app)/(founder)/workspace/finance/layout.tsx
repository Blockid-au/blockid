// /workspace/finance hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function FinanceHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="finance">{children}</HubTabsProvider>;
}
