          ...
          {p.isOwner ? (
            <section className="rounded-2xl border border-surface-200 bg-white p-5" data-testid="team-invite">
              ...
              <form onSubmit={sendInvite} className="mt-3 flex flex-wrap items-end gap-2">
                ...
                <button type="submit" disabled={invite.kind === "busy" || full} className="inline-flex min-h-9 items-center rounded-lg bg-brand-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60" data-testid="invite-submit">
