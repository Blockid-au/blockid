// /workspace/exit hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function ExitHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="exit">{children}</HubTabsProvider>;
}
