// /workspace/strategy/roadmap — Founder-authored quarterly milestones.
// Distinct from /workspace/plan (the platform's growth-phase gates).
...
export default async function Page() {
  ...
  if (!user) redirect("/auth/login?next=/workspace/strategy/roadmap");
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-6">
        <header>
          ...
          <p className="text-xs text-muted/70 mt-1">
            ...
            <a href="/workspace/plan" className="text-action hover:underline">/workspace/plan</a>.
