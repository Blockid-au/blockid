// /workspace/strategy hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function StrategyHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="strategy">{children}</HubTabsProvider>;
}
