// /workspace/evidence hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function EvidenceHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="evidence">{children}</HubTabsProvider>;
}
