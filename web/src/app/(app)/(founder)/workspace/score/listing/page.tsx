// /workspace/score/listing — auth-gated stub for the founder-side "create a
...
export default async function NewListingPage() {
  ...
  if (!user) redirect("/auth/login?next=/workspace/score/listing");
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-4 -mx-6">
          <NotAvailableYet
            ...
            alternatives={[
              { href: "/workspace/exit/listing", label: "Listing Readiness checklist" },
