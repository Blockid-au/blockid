// /workspace/score hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function ScoreHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="score">{children}</HubTabsProvider>;
}
