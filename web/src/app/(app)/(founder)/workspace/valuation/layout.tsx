// /workspace/valuation hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function ValuationHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="valuation">{children}</HubTabsProvider>;
}
