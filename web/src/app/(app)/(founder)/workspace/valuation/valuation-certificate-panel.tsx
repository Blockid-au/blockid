        ...
        {issueAllowed ? (
          <div className="flex flex-col items-end gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-action px-4 py-2.5 text-sm font-semibold text-white hover:bg-action-hover transition-colors disabled:opacity-60"
            >
