// /workspace/plan hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function PlanHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="plan">{children}</HubTabsProvider>;
}
