  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        {[
          { label: "ESOP Manager", href: "/workspace/esop/manage", desc: "Manage pool & grants" },
          { label: "Cap Table", href: "/workspace/esop/manage", desc: "Full equity structure" },
          { label: "Finance P&L", href: "/workspace/finance", desc: "Salary expense impact" },
          { label: "Accelerator Tracker", href: "/workspace/accelerators", desc: "Show team in pitch binder" },
