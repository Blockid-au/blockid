// /workspace/documents hub layout — G13-W2-IA2 (spec §A.1).
//
...
export default function DocumentsHubLayout({ children }: { children: ReactNode }) {
  return <HubTabsProvider hub="documents">{children}</HubTabsProvider>;
}
