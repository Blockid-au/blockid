...
const CONNECT_URLS: Record<string, string> = {
  stripe: "/workspace/finance/revenue",
  github: "/api/auth/github",
  analytics: "/workspace/analytics",
  linkedin: "https://linkedin.com",
  "blockid-captable": "/workspace/equity/cap-table",
};
          ...
          <div className="flex-1">
            ...
            {driveSetupResult ? (
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-action px-4 py-2 text-xs font-semibold text-on-action hover:bg-action-hover transition-colors"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-action px-4 py-2 text-xs font-semibold text-on-action hover:bg-action-hover transition-colors disabled:opacity-50 cursor-pointer"
              >
                {settingUpDrive ? (
                  <>
