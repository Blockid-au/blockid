        ...
        {items.length > 0 ? (
          ...
          >
            ...
            <Link
              ...
              className="mt-4 inline-flex h-9 items-center gap-1.5 rounded-[10px] bg-action px-5 text-sm font-semibold text-on-action transition-colors hover:bg-action-hover"
            >
              Generate
            </Link>
          </div>
