          ...
          <>
            ...
            <div className="mt-4 flex flex-wrap justify-between gap-2">
              ...
              <div className="flex gap-2">
                ...
                <button type="button" className="rounded-lg border border-brand-600 bg-action px-3 py-1.5 text-sm font-medium text-on-action disabled:opacity-50" onClick={() => void confirm()} disabled={phase.kind === "busy" || ticked.length === 0} data-testid="share-confirm">
