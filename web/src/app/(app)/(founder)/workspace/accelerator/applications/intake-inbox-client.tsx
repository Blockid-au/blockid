        ...
        {created ? (
          <div className="space-y-4 px-6 py-5">
            ...
            <div className="flex justify-end">
              <button type="button" onClick={onClose} className="inline-flex min-h-11 items-center rounded-xl bg-action px-4 py-2.5 text-sm font-semibold text-on-action hover:bg-action-hover">
                Done
              </button>
            </div>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4 px-6 py-5">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button type="submit" disabled={busy || !name.trim()} aria-busy={busy} className="inline-flex min-h-11 items-center gap-2 rounded-xl bg-action px-4 py-2.5 text-sm font-semibold text-on-action hover:bg-action-hover disabled:opacity-60" data-testid="intake-create-submit">
    ...
    <div className="space-y-6" data-testid="intake-inbox">
      ...
      <section className="space-y-3" aria-labelledby="intake-links-title">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <button type="button" onClick={() => setShowCreate(true)} className="inline-flex min-h-11 items-center gap-2 rounded-xl bg-action px-4 py-2.5 text-sm font-semibold text-on-action hover:bg-action-hover" data-testid="intake-create-open">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-wrap justify-end gap-1.5 text-xs">
                          {r.evaluationId && r.latestSvi == null ? (
                            <button type="button" onClick={() => setReportFor(r)} className="rounded-lg bg-action px-2.5 py-1.5 font-semibold text-on-action hover:bg-action-hover" data-testid="intake-score-now">
                              Score now (1 report)
                            </button>
                          ) : null}
                          {r.dossierUrl ? (
