...
| T0237 | CTO | Loop hygiene: nextTaskId max+1, stagePlan select content, TaskStatus merged, self-upgrade-agent priority list → G11, T-id-in-commit rule | patch | ⬜ pending |
