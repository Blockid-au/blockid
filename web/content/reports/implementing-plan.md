...
**Version:** v3.10.0  ·  **Updated:** 2026-09-10T12:25:27.501Z  ·  **Decided by:** ceo (2026-09-10T12:04:03.482Z)
...
| T0237 | CTO | S0 hygiene: re-id orchestrator ID collisions, nextTaskId max+1, TaskStatus merged, stagePlan content select, self-upgrade priority list [T0249,T0250,T0274] + T-id rule, migration 0309_sync_b2b_plan_rows (DB plans = csv), legal entity → PPL Food PTY LTD site-wide, ROADMAP/deploy header drift | patch | 🔄 in_progress |
...
| T0239 | CTO | Migration 0308_au_funding.sql (au_grants, au_programs, funding_reports, project_grant_profiles, public-read RLS) + web/scripts/seed-au-funding.mjs + /admin/funding review page | minor | 🔄 in_progress |
