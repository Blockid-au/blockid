# Chief Information Security Officer — Daily Brief (2026-09-08)
...
- 3fe9b83da — fix(entitlements): resync plan feature flags — the data room was 402ing every tier
- 6a13c8ad9 — fix(data-room): put real content behind the Sprocketbay demo checklist
- 25e602d98 — feat(data-room): migration 0125 — share-link revocation, view attribution, honest doc status
- 54708a0d6 — feat(db): migration 0124 — analyses table + guest_analyses.user_id
- 907836a6c — fix(privacy,billing): require consent for deal flow; stop discarding a paid data room
- 5097118a0 — feat(db): migration 0121 — Growth A$69/45cr, retire Pro A$299
- f1ff7cb07 — fix(billing): right-size included credit grants to hold 70% gross margin
- c42076c6b — fix(billing): provision founder subscription ladder Stripe prices
