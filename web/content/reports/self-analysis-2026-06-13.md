...
## Financial Projections & Professional Valuation (Updated 2026-06-13)

> Generated by BlockID Financial Model v2.0 — `docs/blockid_valuation_2026_v2.xlsx`

### 8-Method Blended Valuation

| Method | Low | Mid | High | Weight |
|--------|-----|-----|------|--------|
| Berkus Method (AU) | A$1,879,500 | A$2,685,000 | A$3,490,500 | 15% |
| Scorecard Method | A$2,736,000 | A$3,420,000 | A$4,275,000 | 25% |
| DCF (5-yr, WACC 35%) | *negative* | *marginal* | *early* | 5% |
| VC Method (10× / 8× ARR) | A$1,890,000 | A$2,700,000 | A$3,780,000 | 22% |
| Revenue Multiple (8× ARR) | *pre-revenue* | *building* | — | 3% |
| SVI-Based (BSI-AU, Stage 3) | A$4,872,000 | A$5,460,000 | A$6,237,600 | 25% |
| Risk Factor Summation | A$3,600,000 | A$4,500,000 | A$5,400,000 | — |
| First Chicago | A$1,751,521 | A$2,502,173 | A$3,252,825 | — |
| **BLENDED (6-method)** | **A$2,409,785** | **A$2,911,121** | **A$3,517,675** | **100%** |

### Revenue Projections (Base Scenario)

| Metric | Month 9 | Month 12 | Month 24 | Month 36 |
|--------|---------|----------|----------|----------|
| Break-Even | ✅ Month 9 | — | — | — |
| Customers | ~22 | ~28 | ~90 | ~290 |
| MRR | A$1,650 | A$2,100 | A$6,750 | A$21,750 |
| ARR | — | A$25,200 | A$81,000 | A$261,000 |
| Cum. Profit/Loss | A$0 (BE) | Positive | Growing | Significant |

### Unit Economics (Base Scenario)

| Metric | Value | Benchmark |
|--------|-------|-----------|
| ARPU | A$75/mo | A$40–A$120 |
| Monthly Churn | 5% | 5–8% SaaS |
| CAC | A$90 | A$60–A$200 |
| LTV (ARPU/Churn) | A$1,500 | ≥3× CAC |
| LTV:CAC Ratio | **16.7×** | ≥3.0× |
| Gross Margin | 78% | 70–85% SaaS |
| Monthly Burn | A$1,056 | — |

### Fundraising Scenarios

| Round | Raise | Pre-Money | Founder Equity After |
|-------|-------|-----------|---------------------|
| Angel (Bootstrapped+) | A$200K | A$1.5M | 88% |
| Startmate Pre-Seed | A$300K | A$2.2M | 88% |
| Seed SAFE | A$500K | A$2.9M | 85% |
| Seed Priced | A$750K | A$3.5M | 82% |
| Series A (target) | A$3M | A$11.6M | 74% |

### 90-Day Priority Actions (SVI Improvement)

| Priority | Action | SVI Impact | Target Score |
|----------|--------|-----------|--------------|
| 🔴 CRITICAL | 50 Founding50 subscribers | TRE +20 | 52→72 |
| 🔴 CRITICAL | Apply Startmate/Antler | CGH +20 | 45→65 |
| 🟠 HIGH | Register BSI™ trademark | LCO +15 | 63→78 |
| 🟠 HIGH | Angel outreach 20 investors | CGH +10 | — |
| 🟠 HIGH | ProductHunt launch | TRE +15 | — |
| 🟡 MEDIUM | SVI API (B2B tier) | PTD +10 | 91→91+ |
| 🟡 MEDIUM | Add advisor (exits) | FTV +10 | 68→78 |

**Projected SVI after 90 days: ~185 (↑ from 156)**  
**Projected valuation after 90 days: A$3.8M–A$6.2M (mid: A$4.9M)**

---
*This report was generated autonomously by the BlockID.au AI Self-Analysis Engine on 2026-06-13. Financial model v2.0 generated by `docs/blockid_financial_model_v2.py`. All figures in AUD. Confidential.*
