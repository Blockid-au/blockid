# Chief Information Security Officer — Daily Brief (2026-08-17)
...
- 7e33b409a — feat(v3.8.2): SVI evidence completeness engine + API routes + cap-table + migrations
- a5d399ae4 — chore(release): commit v3.7.5 support files (lib + migrations)
