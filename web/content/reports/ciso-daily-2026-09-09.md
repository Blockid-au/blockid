# Chief Information Security Officer — Daily Brief (2026-09-09)
...
- 2f029c25f — feat(db): 0131 sync founder_starter feature_flags with plans.csv
- bd9d362e3 — feat(email-drip): expiry guard, suppression check and once-only claim before the queue is ever drained
- 5c3466058 — feat(entitlements): give the entitlements table a reader so add-ons can be sold
- edb2aa778 — feat(free-tier): migration 0130 — once-only delivery marker for the free summary
- 80f36bcf7 — chore(migrations): renumber the second 0128 to 0129
- accc2379a — feat(publish): opt-in publishing for a completed analysis — schema, gates, store, API
- 7d820a5af — feat(guest-analysis): migration 0128 — abandoned-checkout reconcile + recovery
