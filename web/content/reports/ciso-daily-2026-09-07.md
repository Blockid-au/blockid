# Chief Information Security Officer — Daily Brief (2026-09-07)
...
- e1680ae4b — feat(security): add rate-limit buckets for /api/investor-link, /evidence/upload, /upload, /auth/* (fail-closed for auth)
- 846fe13f8 — feat(demo): seed 3 sample public listings so /listings + /reports/[ticker] have live demo data
