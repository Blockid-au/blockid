  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // G17 D6 — the violet "unicorn" accent (search ring, eyebrows, focus).
        // Semantic pair reads the --ds-highlight vars so it retints per theme;
        // the numeric ramp mirrors --color-accent-* in globals.css.
        accent: {
          DEFAULT: "var(--ds-highlight)",
          soft: "var(--ds-highlight-soft)",
          50: "#f5f3ff",
          100: "#ede9fe",
          200: "#ddd6fe",
          300: "#c4b5fd",
