...
- banner:
  - navigation "Primary":
    ...
    - link "Start free":
      - /url: /onboarding
- main:
  - link "Founding 50 — A$5 lifetime deal · 50 credits, no recurring fees, Founding Member badge Promo ends 31 Aug 2026 →":
    - /url: /founding-50
...
- contentinfo "Site footer":
  ...
  - paragraph: © 2026 Auschain Pty Ltd v3.0.0-phase6-core
- alert
```
