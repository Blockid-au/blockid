...
- Name: a11y/axe.spec.ts >> A11y — public routes (WCAG 2.1 AA) >> axe sweep: /for/investor
- Location: tests/e2e/a11y/axe.spec.ts:61:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/for/investor
Call log:
  - navigating to "http://localhost:3000/for/investor", waiting until "domcontentloaded"
