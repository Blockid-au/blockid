...
- Name: a11y/axe.spec.ts >> A11y — public routes (WCAG 2.1 AA) >> axe sweep: /pricing/founder_growth
- Location: tests/e2e/a11y/axe.spec.ts:61:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/pricing/founder_growth
Call log:
  - navigating to "http://localhost:3000/pricing/founder_growth", waiting until "domcontentloaded"
