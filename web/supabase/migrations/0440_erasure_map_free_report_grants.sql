-- 0440_erasure_map_free_report_grants.sql
-- ---------------------------------------------------------------------------
-- G25-C (2026-09-21): erasure map + erase_account() gain the 0439
-- free_report_grants ledger (keyed by the address, no FK — NON_FK_EXTRAS
-- by: email, mode: delete).
-- ---------------------------------------------------------------------------
BEGIN;
