-- 0348_erase_account.sql — account erasure (S24-B, 2026-09-12)
-- ---------------------------------------------------------------------------
-- `DELETE FROM app_users` is impossible in production: 124 foreign keys point
-- at app_users(id) — 14 NO ACTION, 6 RESTRICT (two of them append-only
-- ledgers that reject UPDATE and DELETE), 23 SET NULL, 81 CASCADE — and the
