...
values
  ...
  ('founder_starter',    'founder', 'Founder Starter',    2900,   29000,  'monthly', 7,
   '["profile.basic","svi.full","data_room.basic"]'::jsonb,
   '{"profiles":1,"svi_per_month":10,"monthly_credits":75,"report_pages":30}'::jsonb, 20),
  ('founder_growth',     'founder', 'Founder Growth',     9900,   99000,  'monthly', 7,
  ...
  ('founder_scale',      'founder', 'Founder Scale',      29900,  299000, 'monthly', 7,
  ...
  -- Investor tier
  ('investor_angel',     'investor_angel', 'Investor Angel',    7900,   79000,  'monthly', 7,
  ...
  ('investor_advisor',   'advisor',        'Advisor',           14900,  149000, 'monthly', 7,
  ...
  ('investor_vc_small',  'investor_vc',    'VC Small Fund',     34900,  349000, 'monthly', 7,
  ...
  -- Accelerator tier
  ('accelerator_starter',    'accelerator', 'Accelerator Starter',    50000,   500000,  'monthly', 7,
   '["cohort.manage","brand.whitelabel","reports.batch"]'::jsonb,
   '{"cohort_size":20,"monthly_credits":2000}'::jsonb, 210),
  ('accelerator_growth',     'accelerator', 'Accelerator Growth',     150000,  1500000, 'monthly', 7,
  ...
  ('accelerator_enterprise', 'accelerator', 'Accelerator Enterprise', 350000,  3500000, 'monthly', 7,
