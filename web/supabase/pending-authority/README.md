...
| `0468_score_views_any_subject.sql` | **applied 26/09/2026** (26/09/2026, G33 follow-up) — additive nullable `svi_analysis_id` FK + one-subject CHECK; `score_id` NOT NULL relaxed | code (`lib/share/score-views.ts`) tolerates it missing: analysis-share views are skipped as before, score shares unchanged |
