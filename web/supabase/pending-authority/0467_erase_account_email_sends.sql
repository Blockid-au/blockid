-- 0467_erase_account_email_sends.sql
--
-- G34 BT2 follow-up (2026-09-25): the send log `email_sends` (0465) keys
-- recipients by sha256(lower(trim(address))) only. A new non-FK extra key
-- kind `email_sha256` erases those rows by the pre-erasure address.
-- Body = 0464 byte-for-byte except this header, one CASE branch
-- (keyed = 'email_sha256') and the generated non-fk-extras VALUES block,
